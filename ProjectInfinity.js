...
var sfxlist=[
	...
	{name:"darkness",vm:2},
	{name:"darknesse",vm:2},
	{name:"indestructible",vm:1.5},
	{name:"indestructibleh",vm:1.5},
	{name:"obliteratem",vm:1},
	{name:"obliterates",vm:1},
	{name:"obliterate1",vm:1},
	{name:"obliterate2",vm:1},
	{name:"obliterate3",vm:1},
];
var loadassetscache=function(){
	...
	text("0/3",500,370);
		...
		sfx={
				...
				darkness:new Howl({src: ['Data/Sound/sfx/darkness.ogg'], autoplay: false,loop: true,volume: options.sfx*2,}),
				darknesse:new Howl({src: ['Data/Sound/sfx/darknesse.ogg'], autoplay: false,loop: false,volume: options.sfx*2,}),
				indestructible:new Howl({src: ['Data/Sound/sfx/indestructible.ogg'], autoplay: false,loop: false,volume: options.sfx*1.5,}),
				indestructibleh:new Howl({src: ['Data/Sound/sfx/indestructibleh.ogg'], autoplay: false,loop: false,volume: options.sfx*1.5,}),
				obliteratem:new Howl({src: ['Data/Sound/sfx/obliteratem.ogg'], autoplay: false,loop: false,volume: options.sfx*1,}),
				obliterates:new Howl({src: ['Data/Sound/sfx/obliterates.ogg'], autoplay: false,loop: false,volume: options.sfx*1,}),
				obliterate1:new Howl({src: ['Data/Sound/sfx/obliterate1.ogg'], autoplay: false,loop: false,volume: options.sfx*1,}),
				obliterate2:new Howl({src: ['Data/Sound/sfx/obliterate2.ogg'], autoplay: false,loop: false,volume: options.sfx*1,}),
				obliterate3:new Howl({src: ['Data/Sound/sfx/obliterate3.ogg'], autoplay: false,loop: false,volume: options.sfx*1,}),
		};
		}
		loadassetscache=0;
		canstart=1;
	...
	playertemp.action.run=function(){
		...
		if(playertemp.action.tick==8){
				append(objects,{
					...
					x:playertemp.x,
					y:playertemp.y,
					shieldval:((plsar(0.01))+(plshp(0.025)+(plsre(0.005)))*(1+traitpow/20)),
								...
								run:function(){
									...
									if(pow(playertemp.x-objects[n].x,2)+pow(playertemp.y-objects[n].y,2)<pow(10+player.size+objects[n].speed*2,2)){
										...
										for(crtds=1;crtds<13;crtds+=1){
											shield(objects[n].shieldval,180*crtds/12);
										}
									}
									}
								},
