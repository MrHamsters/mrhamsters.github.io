...
var renderequipslot=function(slot,x,y,interact){
	if(player.inventory[slot]){
		...
		if(itemdata[player.inventory[slot].id*10+3]=="svg"){
			shape(inventorysprites[itemdata[player.inventory[slot].id*10+4]],662+30*n,137+30*x,37,55);
		}
		else if(itemdata[player.inventory[slot].id*10+3]=="img"){
			image(inventorysprites[itemdata[player.inventory[slot].id*10+4]],662+30*n,137+30*x,37,55);
		}
			...
			for(n=0;n<15;n+=1){
				...
				if(player.inventory.bag[15*x+n]){
					if(player.inventory.bag[15*x+n].id==44){
						...
						if(render){
							if(itemdata[player.inventory.bag[invselect[1]].id*10+3]=="svg"){
...
append(nmem,function(i){
	...
	if(enemies[i].action.timeout<=2||enemies[i].stun>0){
		if(enemies[i].action.timeout<=2){
